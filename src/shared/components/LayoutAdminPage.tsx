          ...
          >
            <div className="flex flex-col gap-4 p-6">
              ...
              <div className="flex flex-col gap-1">
                ...
                >
                  <div
                    className={`flex items-center rounded-xl p-4 gap-2 bg-white group-hover:bg-heyhao-grey transition-all duration-300 ${
                      pathname === "/home/revenue" ||
                      pathname === "/home/revenue/withdraw"
                        ? "bg-heyhao-grey group-[.active]:bg-heyhao-grey"
                        : ""
                    }`}
                  >
                    <img
