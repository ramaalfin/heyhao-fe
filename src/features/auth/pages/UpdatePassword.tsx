                            ...
                            <section id="Inputs" className="flex flex-col gap-[30px]">
                                {/* <div id="Email" className="relative">
                                    <div className="relative h-[72px] overflow-hidden rounded-[24px] bg-heyhao-border py-[24px]">
                                        <img src="assets/images/icons/sms-grey.svg" alt="icon" className="absolute left-[24px] top-1/2 size-[24px] shrink-0 -translate-y-1/2" />
                                        <div className="w-px h-6 bg-[#DBDBDB] absolute left-[64px]"></div>
                                        <input readOnly id="Email" placeholder="" type="email" value="Bimore@shaynakit.com" className="peer absolute bottom-0 left-0 right-0 top-0 w-full h-full bg-transparent font-semibold leading-[20px] focus:outline-none pb-[16px] pl-[80px] pt-[36px] z-10" />
                                        <label htmlFor="Email" className="absolute left-[80px] text-heyhao-secondary transition-all duration-300 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 text-sm leading-[17.5px] font-medium top-4 peer-focus:top-4 -translate-y-0 peer-focus:-translate-y-0">Email Address</label>
                                    </div>
                                </div> */}
