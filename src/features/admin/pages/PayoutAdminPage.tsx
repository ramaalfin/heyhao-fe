                ...
                {!isLoading &&
                  data?.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex items-center w-[130px] shrink-0">
                        <p
                          className={`rounded-[50px] py-4 px-6 w-[130px] text-center font-bold leading-5 text-white ${item.status === "PENDING" ? "bg-heyhao-yellow" : item.status === "SUCCESS" ? "bg-heyhao-green" : "bg-heyhao-red"}`}
                        >
                          {item.status}
                        </p>
                      </div>
